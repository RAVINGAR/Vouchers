...
public class FarmVoucher extends Voucher {
    ...
    public FarmVoucher(final String key, final String tier, final ItemType item, final ItemType block, final ItemType seed, final ItemType food, final HolderManager manager) {
        super(key, tier, manager);
