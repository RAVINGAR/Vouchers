...
public class ArmourVoucher extends ItemVoucher {
    ...
    public ArmourVoucher(final ItemType type, final String tier, final String craftTime, final int energyCost, final int moneyCost, final HolderManager manager) {
        super(type, tier, craftTime, energyCost, moneyCost, manager);

        lastDamageCheck = new HashMap<>();

        if(VoucherSettings.preventItemEquipping) {
